    ...
    <center>
        <table border=1>
            <tr>
                <td>
                    Nuevo<br>
                    <form name="formulario" method="post" action="Registro_de_produccion.php">
                 ...
                 <tr>
                    ...
                    <?php
        $conn = mysqli_connect('sql212.byethost17.com','b7_19187821','admin123','b7_19187821_artesanias');
                        $sql = "SELECT * from registroDeProduccion";
                        $result = mysqli_query($conn,$sql);
                        echo "
                            <table border = 1>
                                <tr>
...
?>
            ...
            <script type="text/javascript">
                ...
                document.writeln("<form name='editar' method='post' action='regpEd.php'>Editar<br>Codigo:<input name='codigo' type='text' value='"+id+"' readonly='readonly'>");
               ...
               document.writeln("<br><br><a href='regp.php'>Cancelar</a></center>");
               var selref = -1;
